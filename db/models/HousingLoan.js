  ...
  const HousingLoan = sequelize.define(
    "housingLoans",
    {
      ...
      estimatePlan: {
        ...
        validate: {
          notNull: {
            msg: "Estimate plan is required.",
          },
          notEmpty: {
            msg: "Estimate plan cannot be empty.",
          },
        },
      },
      cibil: {
    ...
    },
    {
      ...
      modelName: "housingLoans",
      hooks: {
        beforeValidate: async (loan) => {
          const currentDate = getCurrentDate();
          const code = "HL";
          const lastLoan = await HousingLoan.findOne({
            where: {
              workId: {
...
module.exports = defineHousingLoan;
